...
export const Menu = ({
	...
	return (
		<nav
			...
			className="shadow-input relative flex w-full flex-wrap justify-center space-x-4 rounded-full border border-transparent bg-white px-8 py-6 dark:border-white/[0.2] dark:bg-black"
		>
			{children}
		</nav>
	);
...
export const ProductItem = ({
	...
	return (
		<a href={href} className="flex space-x-2">
			...
			/>
			<div>
				<h4 className="mb-1 break-words text-sm font-bold text-black dark:text-white">{title}</h4>
